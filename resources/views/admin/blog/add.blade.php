                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="name"> Blog Title <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name" name="blog_title" value="{{old('blog_title')}}"  class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="background-image">Background-Image<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" id="background-image" name="background_image" accept="image/*" class="form-control" onchange="readURL1(this);">
                                    
                                </div>
                                <img src="" id="two" style="width: 100px">
