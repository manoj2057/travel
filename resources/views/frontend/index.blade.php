   ...
   <body class="home">
      <div id="siteLoader" class="site-loader">
         <div class="preloader-content">
            <img src="{{asset('public/frontend/assets/images/loader1.gif')}}" alt="">
         </div>
      </div>
   ...
   @include('includes.frontend.slider')
                        ...
                        <div class="col-lg-7">
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{asset('public/frontend/assets/images/img1.jpg')}}" alt="">
                                    </figure>
                              ...
                              <div class="col-sm-6">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{asset('public/frontend/assets/images/img2.jpg')}}" alt="">
                                    </figure>
                                    <div class="meta-cat bg-meta-cat">
                                       <a href="#">NORWAY</a>
                                    </div>
                        ...
                        <div class="col-lg-5">
                           <div class="row">
                              <div class="col-md-6 col-xl-12">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{asset('public/frontend/assets/images/img3.jpg')}}"alt="">
                                    </figure>
                                    <div class="meta-cat bg-meta-cat">
                              ...
                              <div class="col-md-6 col-xl-12">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{asset('public/frontend/assets/images/img4.jpg')}}" alt="">
                                    </figure>
                                    <div class="meta-cat bg-meta-cat">
                                       <a href="#">SINGAPORE</a>
                                    </div>
                     ...
                     <div class="row">
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{asset('public/frontend/assets/images/img5.jpg')}}" alt="">
                                 </a>
                              </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{asset('public/frontend/assets/images/img6.jpg')}}" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{asset('public/frontend/assets/images/img7.jpg')}}" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
            ...
            <section class="callback-section">
               <div class="container">
                  <div class="row no-gutters align-items-center">
                     <div class="col-lg-5">
                        <div class="callback-img" style="background-image: url (public/frontend/assets/images/img8.jpg);">
                        ...
                        <div class="callback-inner">
                           ...
                           <div class="callback-counter-wrap">
                              <div class="counter-item">
                                 <div class="counter-icon">
                                    <img src="{{asset('public/frontend/assets/images/icon1.png')}}" alt="">
                                 </div>
                              ...
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{asset('public/frontend/assets/images/icon2.png')}}" alt="">
                                 </div>
                                 <div class="counter-content">
                                    <span class="counter-no">
                              ...
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{asset('public/frontend/assets/images/icon3.png')}}" alt="">
                                 </div>
                                 <div class="counter-content">
                                    <span class="counter-no">
                              ...
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{asset('public/frontend/assets/images/icon4.png')}}" alt="">
                                 </div>
                                 <div class="counter-content">
                                    <span class="counter-no">
                           ...
                           <div class="support-area">
                              <div class="support-icon">
                                 <img src="{{asset('public/frontend/assets/images/icon5.png')}}" alt="">
                              </div>
                  ...
                  <div class="activity-inner row">
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/icon6.png')}}" alt="">
                              </a>
                           </div>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/icon10.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/icon9.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/icon8.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/icon7.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/icon11.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                  ...
                  <div class="special-inner">
                     <div class="row">
                        <div class="col-md-6 col-lg-4">
                           <div class="special-item">
                              <figure class="special-img">
                                 <img src="{{asset('public/frontend/assets/images/img9.jpg')}}" alt="">
                              </figure>
                              <div class="badge-dis">
                                 <span>
                                    <strong>20%</strong>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="special-item">
                              <figure class="special-img">
                                 <img src="{{asset('public/frontend/assets/images/img10.jpg')}}" alt="">
                              </figure>
                              <div class="badge-dis">
                                 <span>
                                    <strong>15%</strong>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="special-item">
                              <figure class="special-img">
                                 <img src="{{asset('public/frontend/assets/images/img11.jpg')}}" alt="">
                              </figure>
                              <div class="badge-dis">
                                 <span>
                                    <strong>15%</strong>
                  ...
                  <div class="row">
                     <div class="col-lg-5">
                        ...
                        <figure class="gallery-img">
                           <img src="{{asset('public/frontend/assets/images/img12.jpg')}}" alt="">
                        </figure>
                     </div>
                     <div class="col-lg-7">
                        <div class="row">
                           <div class="col-sm-6">
                              <figure class="gallery-img">
                                 <img src="{{asset('public/frontend/assets/images/img13.jpg')}}" alt="">
                              </figure>
                           </div>
                           <div class="col-sm-6">
                              <figure class="gallery-img">
                                 <img src="{{asset('public/frontend/assets/images/img14.jpg')}}" alt="">
                              </figure>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-12">
                              <figure class="gallery-img">
                                 <img src="{{asset('public/frontend/assets/images/img15.jpg')}}" alt="">
                              </figure>
                           </div>
                        </div>
                     </div>
               ...
               <div class="container">
                  <div class="client-wrap client-slider secondary-bg">
                     <div class="client-item">
                        <figure>
                           <img src="{{asset('public/frontend/assets/images/logo1.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{asset('public/frontend/assets/images/logo2.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{asset('public/frontend/assets/images/logo3.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{asset('public/frontend/assets/images/logo4.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{asset('public/frontend/assets/images/logo5.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           <figure class="feature-image">
                              <a href="#">
                                 <img src="{{asset('public/frontend/assets/images/img17.jpg')}}" alt="">
                              </a>
                           </figure>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           <figure class="feature-image">
                              <a href="#">
                                 <img src="{{asset('public/frontend/""assets/images/img18.jpg')}}" alt="">
                              </a>
                           </figure>
                           <div class="entry-content">
                              <h3>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           <figure class="feature-image">
                              <a href="#">
                                 <img src="{{asset('public/frontend/')}}""assets/images/img19.jpg" alt="">
                              </a>
                           </figure>
                           <div class="entry-content">
                              <h3>
                        ...
                        <div class="testimonial-inner testimonial-slider">
                           <div class="testimonial-item text-center">
                              <figure class="testimonial-img">
                                 <img src="{{asset('public/frontend/assets/images/img20.jpg')}}" alt="">
                              </figure>
                           ...
                           <div class="testimonial-item text-center">
                              <figure class="testimonial-img">
                                 <img src="{{asset('public/frontend/assets/images/img21.jpg')}}" alt="">
                              </figure>
                              <div class="testimonial-content">
                                 <p>" Dolorum aenean dolorem minima! Voluptatum? Corporis condimentum ac primis fusce, atque! Vivamus. Non cupiditate natus excepturi, quod quo, aute facere? Deserunt aliquip, egestas ipsum, eu.Dolorum aenean dolorem minima!? Corporis condi mentum acpri! "</p>
                                 <cite>
                           ...
                           <div class="testimonial-item text-center">
                              <figure class="testimonial-img">
                                 <img src="{{asset('public/frontend/assets/images/img22.jpg')}}" alt="">
                              </figure>
                              <div class="testimonial-content">
                                 <p>" Dolorum aenean dolorem minima! Voluptatum? Corporis condimentum ac primis fusce, atque! Vivamus. Non cupiditate natus excepturi, quod quo, aute facere? Deserunt aliquip, egestas ipsum, eu.Dolorum aenean dolorem minima!? Corporis condi mentum acpri! "</p>
                                 <cite>
            ...
            <section class="contact-section">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-4">
                        <div class="contact-img" style="background-image: url{{asset('public/frontend/assets/images/img24.jpg')}}";>
                        </div>
                     </div>
                     <div class="col-lg-8">
                        <div class="contact-details-wrap">
                           <div class="row">
                              <div class="col-sm-4">
                                 <div class="contact-details">
                                    <div class="contact-icon">
                                      <img src="{{asset('public/frontend/assets/images/icon12.png')}}" alt="">
                                    </div>
                                    <ul>
                                       <li>
                              ...
                              <div class="col-sm-4">
                                 <div class="contact-details">
                                    <div class="contact-icon">
                                       <img src="{{asset('public/frontend/assets/images/icon13.png')}}" alt="">
                                    </div>
                                    <ul>
                                       <li>
                              ...
                              <div class="col-sm-4">
                                 <div class="contact-details">
                                    <div class="contact-icon">
                                       <img src="{{asset('public/frontend/assets/images/icon14.png')}}" alt="">
                                    </div>
                                    <ul>
                                       <li>
